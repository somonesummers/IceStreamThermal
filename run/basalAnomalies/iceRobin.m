...
%Domain
m = 1001;
n = 31; %m,n: dimensions of triangulation
Y = 30e3;
...
drivingRamp = 1;
enforcedMargin = 50e3; %enforcedMargin: margin location [m]
tau_base = -0.5e3 - Z*rho*g*sin(alpha)*(((y)./(14.5*Z)).^100);
tau_base = tau_base - channelSpacing(y,2.5e3,2e3,10e3); 
