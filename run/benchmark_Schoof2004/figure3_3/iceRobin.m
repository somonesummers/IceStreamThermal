...
%Ice Rheology
iceRheol = 1; %iceRheol: ice rheology choice []
...
drivingRamp = 1;
enforcedMargin = 5e3; %enforcedMargin: margin location [m]
tau_base = -rho*g*Z*sin(alpha)*(((y)./(5*Z)).^100);
