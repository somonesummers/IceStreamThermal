...
alpha = 0.0015;
G_base = 46.5e-3;
%!%!%!%!%!%!%!%!%!% Note this should be run with 2*(thermal body force) %!%!%!%!%!%!%!%!%!%
...
drivingRamp = 1;
enforcedMargin = 45e3; %enforcedMargin: margin location [m]
tau_base = -10.0e3*ones(m,1);
...
hold on
plot((-ISE(:,1)+45e3)/Y,ISE(:,2)/(3.1557e7*max(u(m*n-m+1:m*n))),'r.','MarkerSize',20);
axis([0 0.52 0 1.1])
